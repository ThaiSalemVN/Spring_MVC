		...
		<div class="col-lg-4 col-xlg-3 col-md-5">
			<div class="card">
				<div class="card-body" style="height: 380px;">
					...
					<div data-toggle="modal" data-target="#exampleModal" style="float:left; margin-left: 100px;" id="imgLike"  >
						<img alt="" src="resources/admin/images_admin/like.png"
							width="50px" height="50px">
					</div>
					<div data-toggle="modal" data-target="#exampleModal2" style="float:right;margin-right: 100px;" id="imgDisLike" >
			...
			<div class="card-body">
				<form:form action="admin/staffs.htm" modelAttribute="Staff"
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label>Hình</label>
							<form:input path="photo" type="hidden" id="inputHinh" />
						...
						<table class="table table-hover">
							<thead class="thead-light">
								<tr>
									...
									<th scope="col" width="110">Ngày Sinh</th>
									<th scope="col">Giới Tính</th>
									<th scope="col">Email</th>
									<th scope="col">Số Điện Thoại</th>
									<th scope="col">Lương(vnđ)</th>
									<th scope="col">Ảnh</th>
									<th scope="col" width="250">Ghi Chú</th>
									<th scope="col"></th>
								</tr>
							</thead>
							<tbody>
