		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<div>		
						<form:form action="admin/departs.htm" method="Post" modelAttribute="Depart" class="form-inline" style="float: left;">
							
							<div class="form-group mx-sm-3 mb-2">
								<form:input path="id" type="text" class="form-control" id="idform" placeholder="Id"/>
							</div>
							<div class="form-group mx-sm-3 mb-2">
								<form:input path="name" type="text" class="form-control" id="nameform"  placeholder="Name"/>
								
							</div>
								<button type="submit" class="btn btn-primary mb-2" id="someid" name="insert" >Thêm Phòng Ban</button>
							    <button type="submit" class="btn btn-primary mb-2" id="somename" hidden="true"  name="update" >Lưu Thay Đổi</button> 
								...
								<li class="nav-item search-box">Search <a
									...
									<form class="app-search position-absolute"
										...
										<input type="text" class="form-control" name ="tenPB"
											placeholder="Nhap ten &amp; enter"> <a class="srh-btn"><i
											class="ti-close"></i></a>
									</form>
								</li>
							</ul>
